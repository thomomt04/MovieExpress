...
{
	[Serializable]
	public class ReportInterventionManagementSphere
	 : METTBusinessBase<ReportInterventionManagementSphere>
	{
		...
		public static ReportInterventionManagementSphere NewReportInterventionManagementSphere()
		{
			return DataPortal.CreateChild<ReportInterventionManagementSphere>();
		}

		public ReportInterventionManagementSphere()
		{
			MarkAsChild();
		}

		internal static ReportInterventionManagementSphere GetReportInterventionManagementSphere(SafeDataReader dr)
		{
			var r = new ReportInterventionManagementSphere();
			r.Fetch(dr);
			return r;
		}
		...
		protected void Fetch(SafeDataReader sdr)
		{
			using (BypassPropertyChecks)
			{
				...
				LoadProperty(MaxValueProperty, sdr.GetInt32(i++));
		...
		protected override Action<SqlCommand> SetupSaveCommand(SqlCommand cm)
		{
			...
			cm.Parameters.AddWithValue("@MaxValue", GetProperty(MaxValueProperty));
