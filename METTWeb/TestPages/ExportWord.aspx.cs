...
{
	public partial class ExportWord : METTPageBase<ExportWordVM>
	{
	...
	public class ExportWordVM : METTStatelessViewModel<ExportWordVM>
	{
		...
		public void ExportToWord()
		{
			...
			WordDocumentWriter docWriter = WordDocumentWriter.Create(HttpRuntime.AppDomainAppPath + "\\temp\\TestWordExport.docx");
